...
export default function Home() {
  return (
    <Layout title="Dashboard" subtitle="Resumo de suas informações">
      <div className="container max-w-7xl mx-auto">
        <div className="flex flex-col w-full md:space-y-4">
          <div>
            <div className="flex my-6 items-center w-full space-y-4 md:space-x-4 md:space-y-0 flex-col md:flex-row">
              <div className="w-full md:w-6/12">
                <div className="rounded shadow w-full bg-white dark:bg-gray-700 relative ">
                  <a href="#" className="w-full h-full block">
                    <div className="flex flex-col md:flex-row items-center justify-between px-4 py-6 space-x-4">
                    ...
                    <div className="rounded w-full h-3 bg-gray-100">
                      <div className="rounded w-2/5 h-full text-center text-xs text-white bg-green-400"></div>
                    </div>
                  </a>
                </div>
              </div>
              <div className="flex items-center w-full md:w-1/2 space-x-4">
                <div className="w-1/2">
                  <div className="rounded  shadow px-4 py-6 w-full bg-white dark:bg-gray-700 relative ">
